select product_id, product_name, dp.brand_id, dp.category_id, dp.subcategory_id,
db.brand_name as brand_name, dc.category_name as category_name, dsc.subcategory_name as subcategory_name,
